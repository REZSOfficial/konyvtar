<ul class="nav navbar-dark nav-tabs bg-dark p-1 d-flex justify-content-between">
    ...
    <li>
      <form action="/" class="form-inline d-flex flex-row my-2">
        <input class="form-control mr-sm-2" type="text" name="search" placeholder="Keresés" aria-label="Keresés">
        <button class="btn btn-outline-secondary my-2 my-sm-0" type="submit">Keresés</button>
      </form>
    </li>
  </ul>